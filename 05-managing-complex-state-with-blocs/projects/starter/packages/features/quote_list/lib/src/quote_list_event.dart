...
abstract class QuoteListItemFavoritedToggled extends QuoteListEvent {
  const QuoteListItemFavoritedToggled(
    this.id,
  );
...
class QuoteListItemFavorited extends QuoteListItemFavoritedToggled {
  const QuoteListItemFavorited(
    int id,
  ) : super(id);
}

class QuoteListItemUnfavorited extends QuoteListItemFavoritedToggled {
